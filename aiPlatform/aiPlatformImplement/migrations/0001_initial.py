# Generated by Django 4.2.11 on 2024-08-16 08:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('operation', models.CharField(blank=True, default='充值', max_length=100)),
                ('note', models.CharField(blank=True, default='无', max_length=100)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='aiPlatformImplement.useraccount')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('credits', models.IntegerField(default=5, null=True)),
                ('payed', models.BooleanField(default=False)),
                ('price', models.IntegerField(default=68)),
